...
def get_match_score(jd, resume_text, api_key, model="llama3-8b-8192"):
...
# Process button
if st.button("Process Resumes") and jd and api_key and uploaded_files:
    results = []
    ...
    for index, file in enumerate(uploaded_files):
        ...
        match_score = get_match_score(jd, resume_text, api_key)
...
# Footer
st.markdown("---")
st.markdown("ATS Resume Scanner - Powered by Groq LLM")